...
descricao: Cadeia de prompts para migracao incremental do Forge de batch para event-driven.
versao: 1.0.0
tags:
  - devops
  - data-platform
...
inputs:
  ...
  - nome: diagnostico_forge
    descricao: Saida real do Elo 1 com diagnostico, invariantes e lacunas.
  - nome: estrategia_forge
    descricao: Saida real do Elo 2 com estrategia incremental, reversoes e premissas.
---
...
- Cadeia parametrizavel de tres elos.
- Curadoria feita sobre meta-prompting com separacao forçada entre diagnostico, estrategia e plano.
- Escolha metodologica: impedir que um prompt monolitico esconda premissas, pule trade-offs e produza rollout genérico.

Justificativa:
- Migracao grande demais para uma unica resposta costuma sair rasa.
- O Elo 1 precisa observar e enquadrar o problema.
- O Elo 2 precisa decidir caminho incremental e reversivel.
- O Elo 3 precisa transformar isso em plano operacional auditavel.
...
- Modelo principal: GPT-4o mini para custo baixo em cada elo.
- Escalada opcional: GPT-4o quando cada etapa ganhar mais artefatos, mais ambiguidade ou mais dependencias cruzadas.
